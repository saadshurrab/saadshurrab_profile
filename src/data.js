export const content = {
  ...
  ar: {
    ...
    personalData: {
      ...
      bio: "طالب علوم حاسوب في السنة الثانية بجامعة الأقصى بمعدل تراكمي 85.31%. شغوف بهندسة الأنظمة، تحسين قواعد البيانات، تطوير البرمجيات، والحلول البرمجية المؤتمنة.",
      location: "غزة، فلسطين",
      email: "s421078601@gmail.com",
      phone: "+970 593612651",
      dob: "26/10/2004",
      ...
      items: [
        {
          ...
          issuer: "معهد ليرن مور للتدريب والتطوير",
