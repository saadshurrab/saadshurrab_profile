    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased selection:bg-cyan-500 selection:text-slate-950">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 space-y-24 relative z-10">
        ...
        <section id="about" className="space-y-6 pt-8">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-50">
            {personalData.name}
          </h1>
          <p className="text-lg sm:text-xl text-slate-400 max-w-2xl leading-relaxed">
            {personalData.bio}
          </p>
          <div className="flex flex-wrap items-center gap-4 text-sm text-slate-400 font-mono pt-2">
          ...
          <div className="pt-4 flex items-center gap-4">
            <a href="#projects" className="px-5 py-2.5 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-semibold transition-all shadow-lg shadow-cyan-500/20">
              View Systems & Projects
            </a>
            <a href="#contact" className="px-5 py-2.5 rounded-lg border border-slate-800 hover:border-slate-700 hover:bg-slate-900 text-slate-300 font-medium transition-all">
              Get in Touch
            </a>
          </div>
        </section>
